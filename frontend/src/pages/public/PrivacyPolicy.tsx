            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Contact our Data Protection Officer at <span className="text-primary font-medium">privacy@redrelief.org</span> or call our helpline at <span className="text-primary font-medium">1800-XXX-XXXX</span>.
                </p>
              </div>
            </div>
          </div>
