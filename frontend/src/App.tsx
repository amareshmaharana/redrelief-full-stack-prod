...
import BloodStocks from "@/pages/public/BloodStocks";
...
import ClinicRequestBlood from "@/pages/clinic/ClinicRequestBlood";
import ClinicBloodStock from "@/pages/clinic/ClinicBloodStock";
import ClinicChangePassword from "@/pages/clinic/ClinicChangePassword";
...
const clinicNav = [
  ...
  { label: "Request Blood", path: "/clinic/request-blood", icon: Droplets },
  { label: "Blood Stock", path: "/clinic/blood-stock", icon: ClipboardList },
  { label: "Profile", path: "/clinic/profile", icon: User },
  { label: "Change Password", path: "/clinic/change-password", icon: Lock },
];
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      {/* Clinic */}
      <Route path="/clinic" element={<ProtectedHome role="clinic" />} />
      <Route element={<ProtectedLayout role="clinic" navItems={clinicNav} />}>
        <Route path="/clinic/dashboard" element={<ClinicDashboard />} />
        <Route path="/clinic/request-blood" element={<ClinicRequestBlood />} />
        <Route path="/clinic/blood-stock" element={<ClinicBloodStock />} />
